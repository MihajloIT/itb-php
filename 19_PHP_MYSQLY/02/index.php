                                ...
                                if($res->num_rows==0)
                                {
                                    ...
                                    {   ?>
                                        <tr>
                                            ...
                                            <form action="">
                                            <td><a href="read.php?id=<?php echo $row['id'];?>" class="btn btn-info">Pregled</a>
                                            <a href="edit.php?id=<?php echo $row['id'];?>" class="btn btn-success">Izmena</a>
                                            <a href="delete.php?id=<?php echo $row['id'];?>" class="btn btn-danger">Obrisi</a></td>
                                            </form>
                                        </tr>
                                        <?php
                                    }
